...
const buildPreset = (context, opts = {}) => {
  ...
  const preset = {
    plugins: [[_babelPluginTransformClassProperties2.default, opts.transformClassProperties], [_babelPluginTransformDoExpressions2.default, opts.transformDoExpressions], [_babelPluginTransformFunctionBind2.default, opts.transformFunctionBind], [_babelPluginTransformObjectRestSpread2.default, opts.transformObjectRestSpread], modules === "commonjs" && [_babelPluginTransformEs2015ModulesCommonjs2.default, opts.transformES2015ModulesCommonJS], modules === "umd" && [_babelPluginTransformEs2015ModulesUmd2.default, opts.transformES2015ModulesUMD]].filter(Boolean)
  };
  return preset;
};
